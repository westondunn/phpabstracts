<?php
	...
	//Site variables
	$site_title 	 = "phpAbstracts";
	$site_url 		 = "http://mywebsite.com"; //-- Be sure to change this to your login page
	$site_email 	 = "info@mywebsite.com";   //-- This is where the automatically generated e-mails will come from
	$home_title 	 = "Home";
	...
	$custom_language[2] = "French";
	$custom_language[3] = "Spanish";
